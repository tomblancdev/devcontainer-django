...
EMAIL_TOKEN_VALIDATION_EXPIRATION_TIME: int | None = (
    USERS_SETTINGS["EMAIL_TOKEN_VALIDATION_EXPIRATION_TIME"] | 60 * 60 * 24
)

# Password Reset Token Settings
RESET_PASSWORD_TOKEN_EXPIRATION_TIME: int | None = (
    USERS_SETTINGS["RESET_PASSWORD_TOKEN_EXPIRATION_TIME"] | 60 * 60
)

# Auth Token Settings
AUTH_TOKEN_EXPIRATION_TIME: int | None = (
